...
function initScene() {
    ...
    function addGuitar(position, color) {
        BABYLON.SceneLoader.ImportMesh("", "babylon_demo_project/res/meshes/", "guitar.stl", scene, function(meshes) {
    ...
    /* Music */
    const music1 = new BABYLON.Sound("background_music", "babylon_demo_project/res/audio/track02.wav", scene, soundReady, {
        loop: true,
        spatialSound: true,
    ...
    const music2 = new BABYLON.Sound("background_music", "babylon_demo_project/res/audio/track01.wav", scene, soundReady, {
        loop: true,
        spatialSound: true,
        distanceModel: "exponential",
        rolloffFactor: 0.75
    ...
    const music3 = new BABYLON.Sound("background_music", "babylon_demo_project/res/audio/track03.wav", scene, soundReady, {
        loop: true,
        spatialSound: true,
        distanceModel: "exponential",
        rolloffFactor: 0.75
